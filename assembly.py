...
from part_02_outlet_adapter import create_outlet_adapter
...
def main():
    ...
    adapter_shape = get_part_shape(create_outlet_adapter, "part_02_outlet_adapter.step")
    ...
    import Import
    Import.export([body1, body2, body3, body4], os.path.join(EXPORT_BASE, "assembly.step"))
